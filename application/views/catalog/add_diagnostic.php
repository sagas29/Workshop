    ...
    <form id='form_add' novalidate>
        <div class="row">
            <div class="form-group col-lg-12">
                ...
                <input type="text" name="name" id="name" required="" placeholder="Ingrese el nombre del diagnostico" class="form-control"
        ...
        <div class="row">
            <div class="form-group col-lg-12">
                ...
                <input type="text" name="description" id="description" required="" placeholder="Ingrese la descripcion del diagnostico" class="form-control"
                       parsley-trigger="change" data-parsley-error-message="El campo es requerido">
            </div>
        </div>
