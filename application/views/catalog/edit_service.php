    ...
    <div class="container-fluid">
        <div class="row mt-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Editar Servicio</h4>
                        <?php echo form_open('', array('id' => 'form_edit', 'novalidate' => '')); ?>
                        <!-- <form id="form_add" novalidate>-->
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <label for="name">Nombre<span class="text-danger">*</span></label>
                                <input type="text" name="name" id="name" required="" placeholder="Ingrese el nombre del servicio" class="form-control" value="<?=$data->name;?>"
                                       parsley-trigger="change" data-parsley-error-message="El campo es requerido">
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="description">Descripción<span class="text-danger">*</span></label>
                                <input type="text" name="description" required="" placeholder="Ingrese la descripcion del servicio" class="form-control" id="year" value="<?=$data->description;?>"
                                       parsley-trigger="change" data-parsley-error-message="El campo es requerido">
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <select name="category" id="category" class="form-control select2" required="" parsley-trigger="change" data-parsley-error-message="El campo es requerido">
                                    ...
                                    <?php foreach ($category as $row): ?>
                                        <option value="<?=$row->id_category?>"
                                            <?php if ($row->id_category == $data->id_category): ?>
                                                <?= "selected" ?>
                                            <?php endif; ?>
                                        > <?= $row->name ?> </option>
                                    <?php endforeach; ?>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" name="price" required="" placeholder="Ingrese el precio del servicio" class="form-control" value="<?=$data->price;?>"
                                       parsley-trigger="change" data-parsley-error-message="El campo es requerido">
                            </div>
                        </div>
                        <div class="form-group text-right m-b-0">
                            ...
                            <input type="hidden" value="<?=$data->id_service?>" name="id_service" id="id_service">
