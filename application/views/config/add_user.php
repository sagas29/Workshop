                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" name="fname" id="fname" required="" placeholder="Ingrese el nombre" class="form-control"
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" name="lname" id="lname" required="" placeholder="Ingrese la apellid" class="form-control" id="lname"
                                       parsley-trigger="change" data-parsley-error-message="El campo es requerido">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" name="username" id="username" required="" placeholder="Ingrese la nombre del usuario" class="form-control"
                                       parsley-trigger="change" data-parsley-error-message="El campo es requerido" autocomplete="off">
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="password">Contraseña <span class="text-danger">*</span></label>
                                <input type="password" name="password" required="" placeholder="Ingrese la contraseña" class="form-control"
                                       parsley-trigger="change" data-parsley-error-message="El campo es requerido" autocomplete="off">
                            </div>
                        </div>
                        <div class="row">
